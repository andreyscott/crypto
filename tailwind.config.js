      ...
      extend: {
        ...
        linearBorderGradients: {
          ...
          colors: {
            ...
            'border-gradient': ['#f88311',  '#f83811'],
             // bg-gradient-to-t  from-[#f88311] to-[#f83811]
          // bgGradientToT: "linear-gradient(to top, #f88311, #f83811)",
          // bg-gradient-to-b  from-[#f83811] to-[#f88311]
          // bgGradientToB: "linear-gradient(to bottom, #f83811, #f88311)",
