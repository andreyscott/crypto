...
export const Cta = () => {
  return (
    <div className=' bg-darkBg h-full text-white  pt-32 bgimg relative w-full text-center flex flex-col items-center justify-center '>

<p className=' text-4xl text-primary pb-4  font-medium xl:text-7xl  xl:font-bold lg:text-5xl  sm:text-3xl flex-wrap w-5/6  '>
            <span className='text-white text-4xl font-medium'>USDAO</span> Truly Decentralized Global Digital Currency
          </p>
        

        <p className=" text-secondary text-xl mt-5 w-3/6   ">
          A 100% crypto-backed and fully collateralized stablecoin withs
          decentralized governance.
        </p>

        <div className="btn-wrap flex justify-evenly  lg:justify-around mb-6 pb-3 min-w-lg   items-center lg:w-2/6 mt-10">
          <a
            href="#"
            target="_blank"
            rel="noreferrer"
            className="btn inline-flex w-fit h-12  justify-between  btnstyle hover:bg-gradient-to-t  from-[#f88311] to-[#f83811] "
          >
            <svg
              className="rotate-0 m-1 hover:text-white "
              width="18"
              height="18"
              viewBox="0 0 18 18"
              fill="none"
          ...
          <span className=' ml-6 mr-3'>  Launch App</span>
          </a>
          ...
          >
            <svg
              className="m-2 text-green-500 hover:text-white"
              width="17"
              height="19"
              viewBox="0 0 17 19"
              fill="none"
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stop-color="#F88311" className='hover:text-white' />
                  <stop offset="1" stop-color="#F83811" />
                </linearGradient>
                <linearGradient
  ...
  <div class="text-center">
    ...
    <button type="button" class="inline-flex items-center px-6 py-3 border-gradient-br-blue-green-gray-800 border-solid border-2 rounded-xl text-gray-100 text-lg">Button text</button>
  </div>
  <div class="text-center m-8 pt-8">
    ...
    <button type="button" class="inline-flex borders-2 border-primary  items-center px-6 py-3 hover:border-gradient-tl-blue-green-gray-900 gradient-border-3 rounded-xl text-gray-100 text-lg">Button text</button>
  </div>
</div> */}
