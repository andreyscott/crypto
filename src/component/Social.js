...
const Social = (props) => {
  return (
    <>
      <div className="social 2xl:px-64 2xl:pb-36 px-8 pb-20 lg:px-20 lg:pb-32  xl:px-48 xl:pb-32  ">
        <p className="title-line text-center text-white text-4xl font-medium mb-9">
          <span className='span text-primary'>{props.socialHighlight}</span> {props.socialTitle}
        </p>

        {/* <div className="gy-5 flex justify-center items-center footerSocialIconWrap">
           <div className=" mr-4">
            <a
              href="https://t.me/+OQs8vpFYrsc2ZGJh"
              target="_blank"
              rel="noreferrer"
              className="social-wrap  social-wraprep"
            >
              <div className="social-link hover:rotate-0">
                <svg
                  width="35"
                  height="30"
                  className='svg'
...
<div className=" flex flex-col md:flex-row px-14 justify-center items-center footerSocialIconWrap">
          ...
          <div className='mr-4 pr-4'>
            <a
              ...
              className="social-wrap  social-wraprep"
            >
              <div className="social-link text-base xl:text-xl font-normal hover:rotate-0">
                <svg
                  width="32"
                  height="31"
                  className='svg'
         ...
         {/* <span className='span text-base xl:text-xl font-normal social-link'> */}
                LinkedIn
         {/* </span> */}
              </div>
            </a>
